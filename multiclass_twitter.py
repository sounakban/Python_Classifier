...
for i in range(10):
    ...
    train_labels = [["pos"]] * int(len(postweet) * train_cut)
    train_labels.extend([["neg"]] * int(len(postweet) * train_cut))
    test_labels = [["pos"]] * (len(postweet) - int(len(postweet) * train_cut))
    test_labels.extend([["neg"]] * (len(postweet) - int(len(postweet) * train_cut)))
